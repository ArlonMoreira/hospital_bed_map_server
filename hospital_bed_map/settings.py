"""
Django settings for hospital_bed_map project.
...
INSTALLED_APPS = [
    ...
    'hospital_bed_map.accounts',
    'hospital_bed_map.hospital_beds',
    'corsheaders',
]
...
ROOT_URLCONF = 'hospital_bed_map.urls'
...
WSGI_APPLICATION = 'hospital_bed_map.wsgi.application'
